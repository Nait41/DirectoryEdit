...
import fileView.GenusOrSpeciesTableTSV;
                        ...
                        if(checkLoad & checkUnload){
                            ...
                            new Thread(){
                                ...
                                public void run(){
                                    ...
                                    GenusOrSpeciesTableTSV genusTableTSV = null, speciesTableTSV = null;
                                    InfoList infoList = null;
                                    if(loadFile.getPath().contains(".xlsx"))
                                    {
                                        loadStatusFileNumber.setText("Обработка входного файла");
                                        try {
                                            genusTableTSV = new GenusOrSpeciesTableTSV(new File(Application.rootDirPath + "\\allInfo.txt"));
                                        ...
                                        try {
                                            genusTableTSV.getTable(infoList);

                                            mainLoader.setSystematicsGenus(infoList);
                                            mainLoader.setSystematicsSpecies(infoList);
